...
public class MenuUsuarios {
    ...
    private void recuperarSenha(Usuario u) throws Exception {
        System.out.println("\n-- Recuperação de Senha --");
        System.out.println("Pergunta secreta: " + u.getPerguntaSecreta());
        System.out.print("Resposta: ");
        String resposta = console.nextLine();

        if (resposta.equals(u.getRespostaSecreta())) {
            System.out.println("Resposta correta!");
            System.out.print("Digite sua nova senha: ");
            String novaSenha = console.nextLine();

            // Garante que a senha não seja vazia
            if (novaSenha.trim().isEmpty()) {
                System.out.println("A nova senha не pode ser vazia. Operação cancelada.");
                ConsoleUtils.pausar();
                return;
            }

            u.setHashSenha(hashSenha(novaSenha));
            if (arqUsuarios.update(u)) {
                System.out.println("Senha alterada com sucesso! Tente fazer o login novamente.");
            } else {
                System.out.println("Ocorreu um erro ao alterar a senha.");
            }
        } else {
